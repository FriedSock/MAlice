...
public class MAlice {
    ...
    public static void main(String[] args) {
        ...
        try {
         ...
         lexer = new MAliceLexer(new ANTLRStringStream("i was a number and i became simpleSum(2,3). i spoke. The room simpleSum ( number l, number m ) contained a number Alice found l+m."));
        }
